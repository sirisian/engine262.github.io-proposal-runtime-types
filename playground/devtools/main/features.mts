...
import { Engine262Feature, FEATURES } from "@engine262/engine262";
    ...
    async run() {
      ...
      for (const feature of [
        ...FEATURES,
        {
          ...
          name: L.engine262.includeTest262Env,
          url: "",
...
export function syncFeatureToVM() {
  ...
  Engine262ConnectionTransport.instance?.sendRawMessage?.(
    JSON.stringify({ id: "", method: "Debugger.engine262_setFeatures", params: { features } }),
  );
}
