...
export const L = {
  app: { main: "Main", networkTitle: "Scripts", showNode: "Show Scripts" },
...
export const S: Record<
  "app" | "settings" | "engine262",
  (id: string, values?: Record<string, string | number | boolean>) => Common.UIString.LocalizedString
> = {
