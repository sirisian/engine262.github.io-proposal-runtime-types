...
export const generics: ExampleChapter = [
  ...
  },
  {
    ...
    summary: "With no variance declared, instantiations relate only to themselves (the spec assigns declared variance a meaning but its grammar has no spelling for the declaration yet: KNOWN-DIVERGENCES.md D11).",
